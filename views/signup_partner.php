...
<div class="max-w-md w-full p-8 shadow-md mx-auto bg-neutral-800 mt-10">
    <form onsubmit="validate(event, signup_partner); return false;">
        ...
        <div class="mb-2">
            ...
            <input id="user_address" name="user_address" class="border-2 w-full px-3 py-2" type="text" 
                data-validate="str" data-min="<?= USER_ADRESS_MIN ?>" data-max="<?= USER_ADRESS_MAX ?>"
    ...
    <p><a href="/views/signup.php" class="font-bold text-white">Become a customer</a></p>
